...
import org.bandrsoftwares.cosmosmanager.backend.service.exception.FailToFormatPhoneNumber;
import org.bandrsoftwares.cosmosmanager.backend.service.exception.NotPhoneNumberException;
import org.bandrsoftwares.cosmosmanager.backend.service.exception.UnsupportedPhoneNumberException;
...
public class PhoneTool {
    ...
    /**
     * Try to find a {@link PhoneFormatter} which support the phone number. The first {@code PhoneTool.PhoneFormatter} find which support the phone
     * number will try to format it. If the formation success, returns the formatted phone number, else return null.
     * <p>

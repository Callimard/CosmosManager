...
CREATE UNIQUE INDEX `user_email_UNIQUE` ON `CosmosManager`.`CosmosManagerUser` (`email` ASC) VISIBLE;

CREATE UNIQUE INDEX `user_phone_UNIQUE` ON `CosmosManager`.`CosmosManagerUser` (`phone` ASC) VISIBLE;

CREATE INDEX `user_first_name_idx` ON `CosmosManager`.`CosmosManagerUser` (`firstName` ASC) VISIBLE;

CREATE INDEX `user_last_name_idx` ON `CosmosManager`.`CosmosManagerUser` (`lastName` ASC) VISIBLE;

CREATE INDEX `user_last_name_first_name_idx` ON `CosmosManager`.`CosmosManagerUser` (`lastName` ASC, `firstName` ASC) VISIBLE;

CREATE INDEX `user_creation_date_idx` ON `CosmosManager`.`CosmosManagerUser` (`creationDate` ASC) VISIBLE;
...
CREATE INDEX `fk_User_Roles_Role_idx` ON `CosmosManager`.`UserRoles` (`idRole` ASC) VISIBLE;

CREATE INDEX `fk_User_Roles_User_idx` ON `CosmosManager`.`UserRoles` (`idUser` ASC) VISIBLE;
...
CREATE INDEX `fk_Project_Scope_idx` ON `CosmosManager`.`Project` (`idScope` ASC) VISIBLE;
...
CREATE INDEX `project_workspace_estimated_time_idx` ON `CosmosManager`.`Project` (`workspace` ASC, `estimatedTime` ASC) VISIBLE;

CREATE INDEX `project_workspace_achieved_idx` ON `CosmosManager`.`Project` (`workspace` ASC, `achieved` ASC) VISIBLE;

CREATE INDEX `project_workspace_closed_idx` ON `CosmosManager`.`Project` (`workspace` ASC, `closed` ASC) VISIBLE;
...
CREATE INDEX `milestone_project_creation_date_idx` ON `CosmosManager`.`Milestone` (`project` ASC, `creationDate` ASC) VISIBLE;

CREATE INDEX `milestone_project_begin_date_idx` ON `CosmosManager`.`Milestone` (`project` ASC, `beginDate` ASC) VISIBLE;

CREATE INDEX `milestone_project_due_date_idx` ON `CosmosManager`.`Milestone` (`project` ASC, `dueDate` ASC) VISIBLE;

CREATE INDEX `milestone_project_achieved_idx` ON `CosmosManager`.`Milestone` (`project` ASC, `achieved` ASC) VISIBLE;

CREATE INDEX `milestone_project_closed_idx` ON `CosmosManager`.`Milestone` (`project` ASC, `closed` ASC) VISIBLE;
...
CREATE INDEX `fk_Project_Assigned_Team_Team_idx` ON `CosmosManager`.`ProjectAssignedTeam` (`idTeam` ASC) VISIBLE;

CREATE INDEX `fk_Project_Assigned_Team_Project_idx` ON `CosmosManager`.`ProjectAssignedTeam` (`idProject` ASC) VISIBLE;
...
CREATE INDEX `fk_Workspace_Users_User_idx` ON `CosmosManager`.`WorkspaceUsers` (`idUser` ASC) VISIBLE;

CREATE INDEX `fk_Workspace_Users_Workspace_idx` ON `CosmosManager`.`WorkspaceUsers` (`idWorkspace` ASC) VISIBLE;
...
CREATE UNIQUE INDEX `email_to_verify_nonce_UNIQUE` ON `CosmosManager`.`EmailToVerify` (`nonce` ASC) VISIBLE;

CREATE UNIQUE INDEX `email_to_verify_user_nonce_UNIQUE` ON `CosmosManager`.`EmailToVerify` (`nonce` ASC) VISIBLE;

CREATE UNIQUE INDEX `email_to_verify_email_UNIQUE` ON `CosmosManager`.`EmailToVerify` (`email` ASC) VISIBLE;
...
CREATE INDEX `fk_ForgottenPassword_CosmosManagerUser_idx` ON `CosmosManager`.`ForgottenPassword` (`cosmosManagerUser` ASC) VISIBLE;

CREATE UNIQUE INDEX `forgotten_password_nonce_UNIQUE` ON `CosmosManager`.`ForgottenPassword` (`nonce` ASC) VISIBLE;
